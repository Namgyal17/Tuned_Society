...
const ConsultationModal: React.FC = () => {
    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            <div className="relative bg-[#0a0a0a] w-full max-w-4xl max-h-[90vh] flex flex-col overflow-hidden rounded-2xl border border-white/10 shadow-[0_0_50px_-12px_rgba(220,38,38,0.2)] animate-fadeInUp">
                <button
                    onClick={close}
                ...
                {/* Header & Progress */}
                <div className="px-8 pt-8 pb-6 shrink-0 z-10 bg-[#0a0a0a]">
                                ...
                                <div className="ml-auto">
                                    ...
                                    {currentStep === 6 && (
                                        <button
                                            ...
                                            className="btn btn-primary px-8 py-3 disabled:opacity-50 disabled:cursor-not-allowed disabled:shadow-none"
                                        >
                                            Next Step
                                        </button>
                                    )}
                                    ...
                                    {currentStep === 7 && (
                                        <button
                                            ...
                                            className="btn btn-primary disabled:opacity-50 disabled:cursor-not-allowed disabled:shadow-none min-w-[140px] flex justify-center py-3 px-8"
                                        >
                                            {isSubmitting ? (
